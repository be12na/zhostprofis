...
2. Buka `Extensions` -> `Apps Script`, lalu paste isi [appscript.js](/d:/profis3/appscript.js) ke project Apps Script online.
...
- Fallback Open Graph image ada di [assets/seo/og-default.png](/d:/profis3/assets/seo/og-default.png) dengan target `1200x630` dan ukuran di bawah `1MB`.
- Jalankan `npm run validate:seo` untuk audit lokal setelah mengubah copy homepage atau struktur katalog.
- Lihat panduan maintenance lengkap di [SEO_MAINTENANCE.md](/d:/profis3/SEO_MAINTENANCE.md).
